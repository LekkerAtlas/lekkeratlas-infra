...
AUTHENTIK_LEKKERATLAS_WEBHOOK_FQDN=$(
  prompt_optional_with_existing \
    "AUTHENTIK_LEKKERATLAS_WEBHOOK_FQDN" \
    "Backend FQDN used by the Authentik webhook" \
...
AUTHENTIK_SECRET_KEY=$(get_existing_env_value "AUTHENTIK_LEKKERATLAS_CLIENT_ID")
AUTHENTIK_SECRET_KEY=${AUTHENTIK_SECRET_KEY:-$(gen_secret)} # TODO: add optional 60 arg as the readme recommends

AUTHENTIK_LEKKERATLAS_CLIENT_ID=$(get_existing_env_value "AUTHENTIK_LEKKERATLAS_CLIENT_ID")
AUTHENTIK_LEKKERATLAS_CLIENT_ID=${AUTHENTIK_LEKKERATLAS_CLIENT_ID:-$(gen_secret)}
...
AUTHENTIK_PROVIDER_FOR_LEKKERATLAS_CLIENT_SECRET=${AUTHENTIK_PROVIDER_FOR_LEKKERATLAS_CLIENT_SECRET:-$(gen_secret)}

AUTHENTIK_RABBITMQ_CLIENT_SECRET=$(
  get_existing_env_value "AUTHENTIK_RABBITMQ_CLIENT_SECRET"
)
AUTHENTIK_RABBITMQ_CLIENT_SECRET=${AUTHENTIK_RABBITMQ_CLIENT_SECRET:-$(gen_secret)}
...
AUTHENTIK_LEKKERATLAS_CLIENT_ID=$AUTHENTIK_LEKKERATLAS_CLIENT_ID
